...
def map_organization_name(org_login: str) -> str:
    ...
    org_mapping = {
        'Advanced-Analytics-NHS-Wales': 'Advanced Analytics NHS Wales',
        ...
        'Aneurin-Bevan-UHB': 'Aneurin Bevan University Health Board',
        'Betsi-Cadwaladr-University-Health-Board': 'Betsi Cadwaladr University Health Board',
        'Betsi-Cadwaladr-UHB': 'Betsi Cadwaladr University Health Board',
        'Cardiff-Vale-University-Health-Board': 'Cardiff and Vale University Health Board',
        'Cardiff-and-Vale-UHB': 'Cardiff and Vale University Health Board',
        'Cwm-Taf-Morgannwg-UHB': 'Cwm Taf Morgannwg University Health Board',
        'TBUHB-Cwm-Taf-Morgannwg-University-Health-Board': 'Cwm Taf Morgannwg University Health Board',
        'DHCW-Digital-Health-and-Care-Wales': 'Digital Health and Care Wales (DHCW)',
        'GIGCymru': 'GitHub GIG Cymru',
        'Genomics-Partnership-Wales': 'Genomics Partnership Wales',
        'HDUHB-Hywel-Dda-University-Health-Board': 'Hywel Dda University Health Board',
        'Hywel-Dda-UHB': 'Hywel Dda University Health Board',
        'NDR-National-Data-Analytics-Platform': 'NDR National Data Analytics Platform',
        'NHS-Executive': 'NHS Executive',
        'NHS-Wales-Shared-Services-Partnership': 'NHS Wales Shared Services Partnership',
        'NHS-Wales': 'NHS Wales',
        'National-Data-Resource': 'National Data Resource (NDR)',
        'National-Data-Resource-NDR': 'National Data Resource (NDR)',
        ...
        'Secure-Data-Environment-GIG-Cymru': 'Secure Data Environment GIG Cymru',
        'Swansea-Bay-University-Health-Board': 'Swansea Bay University Health Board',
        'Swansea-Bay-UHB': 'Swansea Bay University Health Board',
        'Velindre-University-NHS-Trust': 'Velindre University NHS Trust',
